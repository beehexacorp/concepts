...
- Khi một sự kiện __X__ xảy ra ở hệ thống __A__ , sẽ dẫn tới có một tập dữ liệu __D__ được thêm mới hoặc thay đổi trên hệ hống __A__.
- Tiến trình đồng bộ dữ liệu sẽ tạo ra một sự kiện __X1__ xảy ra trên hệ thống B với tập dữ liệu __D1__ được thêm mới hoặc thay đổi trên __B__.
